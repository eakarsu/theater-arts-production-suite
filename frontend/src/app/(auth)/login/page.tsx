...
export default function LoginPage() {
  ...
  const onSubmit = async (event: FormEvent) => {
    ...
    setSubmitting(false);
    if (!ok) {
      setError('Use the seeded theater arts production suite demo credentials.');
      return;
    }
  ...
  return (
    <div className="auth-wrap">
      <div className="auth-card">
        ...
        <div className="muted">
          One login for theater arts production features, documents, notifications, audit, approvals, and AI operations.
        </div>
