...
export default function DashboardPage() {
  return (
    <UnifiedShell
      ...
      title="Theater Arts Production Dashboard"
      subtitle="One merged theater arts production view for Projects, Assets, Calendar, Scripts, Approvals, documents, audit, and AI."
    >
      ...
      <div className="grid columns-2">
        <div className="card stack">
          ...
          <div className="muted">
            This suite removes project-based navigation and groups shared theater arts production jobs into one surface. Projects, Assets, Calendar, Scripts, Approvals, Rights, documents, audit, and AI are presented as platform features.</div>
