export const AUTH_COOKIE = 'theater_arts_production_suite_session';
...
export const demoUsers: DemoUser[] = [
  {
    email: 'admin@theater-arts-production.local',
    password: 'admin123',
    firstName: 'Legal',
    lastName: 'Operator',
    role: 'admin',
  ...
  {
    email: 'manager@theater-arts-production.local',
    password: 'manager123',
    firstName: 'Legal',
    lastName: 'Manager',
    role: 'manager',
  ...
  {
    email: 'analyst@theater-arts-production.local',
    password: 'analyst123',
    firstName: 'Legal',
    lastName: 'Analyst',
    role: 'analyst',
