...
const adminCookie = await login('admin@theater-arts-production.local', 'admin123');
const managerCookie = await login('manager@theater-arts-production.local', 'manager123');
const analystCookie = await login('analyst@theater-arts-production.local', 'analyst123');
