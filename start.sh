...
PORT="${PORT:-5190}"
DB_NAME="${PGDATABASE:-theater_arts_production_suite}"
DB_HOST="${PGHOST:-127.0.0.1}"

echo "======================================="
echo "      Theater Arts Production Suite"
echo "======================================="
echo
...
echo "Starting theater arts production suite frontend on http://localhost:$PORT"
echo "Login: admin@theater-arts-production.local / admin123"
